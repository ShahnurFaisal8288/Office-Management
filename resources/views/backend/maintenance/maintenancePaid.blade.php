                    ...
                    <table class="table table-hover table-borderd" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Paid</td>
                                <td>
                                    {{-- <a class="btn btn-outline-success" href=""><i class="fas fa-eye"></i></a> --}}
                                    <a class="btn btn-outline-dark" href="{{ route('maintenance.reciept',$value->id) }}"><i class="fas fa-print"></i></a>
                                </td>
