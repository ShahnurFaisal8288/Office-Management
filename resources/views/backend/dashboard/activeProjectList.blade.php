            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-hover table-borderd" id="example">
                        ...
                        <tbody>
                            @php $i = 1 @endphp
                            @foreach($activeProjectList as $value)
                            <tr>
                                <td>{{ $i++ }}</td>
                                ...
                                <td>
                                    @if($value->progress_status == 'incomplete')
                                    <a class="btn btn-danger" href="{{ route('taskProgressStatus',$value->id) }}">{{ $value->progress_status }}</a>
                                    @else
                                    <a class="btn btn-success" href="{{ route('taskProgressStatus',$value->id) }}">{{ $value->progress_status }}</a>
                                    @endif
